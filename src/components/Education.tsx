                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <ul className='list-disc px-6'>
                                <li className='cursor-default'>Development of a database for storing and processing parallel corpus of translated texts (2023)</li>
                                <li className='cursor-default'>Classification of the known methods of text machine translation (2022)</li>
                                <li className='cursor-default'>Development of a program for generating a realistic tree growth process animation (2022)</li>
                            </ul>
                        </div>
                        <div>
